...
import {mkdirSync,copyFileSync,cpSync,readFileSync,readdirSync,writeFileSync} from 'node:fs';
...
copyFileSync('LICENSE',`${dir}/LICENSE`);copyFileSync('README.md',`${dir}/README.md`);cpSync('docs',`${dir}/docs`,{recursive:true});
