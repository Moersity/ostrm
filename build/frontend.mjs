...
execFileSync(npm,['run','generate'],{cwd:'frontend',stdio:'inherit',env:{...process.env,NUXT_PUBLIC_APP_VERSION:process.env.NUXT_PUBLIC_APP_VERSION||process.env.OSTRM_VERSION||'3.0.0-dev'},shell:process.platform==='win32'});
